...
%% Remove the countries without neonatal mortality data from the other sets
EditPop = EditSet(PopulationData, countries);
EditSan = EditSet(SanitationData, countries);
EditGni = EditSet(GniData, countries);
%%   
for i = 1:229,
